...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{route('category.show',$category->id)}}" class="btn btn-sm btn-primary " >Ver</a>
                <a href="{{route('category.edit',$category->id)}}" class="btn btn-sm btn-success" >Actualizar</a>                
